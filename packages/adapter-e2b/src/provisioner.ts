...
import type { RuntimeAdapter, RuntimeProvisionOptions, RuntimeProvisioner } from "@contextsdk/core";
...
export class E2BProvisioner implements RuntimeProvisioner {
  ...
  async createSessionRuntime(options: RuntimeProvisionOptions & E2BAdapterOptions = {}): Promise<RuntimeAdapter> {
